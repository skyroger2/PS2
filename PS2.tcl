...
#
# PS2.tcl: Tcl script for re-creating project 'PS2'
#
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/PS2.srcs/sources_1/imports/PS2_Controller"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/PS2.srcs/sources_1/imports/PS2_Controller/Altera_UP_PS2_Data_In.v"]"\
 "[file normalize "$origin_dir/PS2.srcs/sources_1/imports/PS2_Controller/Altera_UP_PS2_Command_Out.v"]"\
 "[file normalize "$origin_dir/PS2.srcs/sources_1/imports/PS2_Controller/PS2_Controller.v"]"\
 "[file normalize "$origin_dir/PS2.srcs/sources_1/imports/PS2_Controller/component.xml"]"\
]
...
set file "PS2_Controller/component.xml"
...
set obj [get_filesets sources_1]
set_property "top" "PS2_Controller" $obj
